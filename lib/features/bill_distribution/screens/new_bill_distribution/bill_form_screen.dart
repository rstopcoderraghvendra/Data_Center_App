    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final billData = {
          ...
          'name': _nameController.text.trim(),
          'property_details': _propertyIdController.text.trim(),
          ...
          'integrated_pid': _integratedPidController.text.trim(),
          'integrated_owner': _integratedOwnerController.text.trim(),
        ...
        if (widget.isEditMode && widget.bill != null) {
          ...
          // Create new bill - projectId is required
